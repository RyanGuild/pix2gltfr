...
var _cargoToml = require("./pix2gltfr/Cargo.toml");
console.log(_cargoToml.image_to_gltf);
const fileInput = document.querySelector("#file-input");
const inCanvases = document.querySelector("#in-canvases");
const outCanvases = document.querySelector("#out-canvases");
const imageContainer = document.querySelector("#image-container");
const fileEventToFileList = (event)=>event.target.files
;
const dataUrlToImage = (dataUrl, index)=>{
...
const imageToCanvas = (image, index)=>{
    const canvas = document.querySelector(`canvas-${index}`) || document.createElement("canvas");
...
const canvasToImageData = (canvas)=>canvas.getContext("2d").getImageData(0, 0, canvas.width, canvas.height)
;
const objURLset = new Set();
addEventListener("change", async (event)=>{
    ...
    if (files.length > 0) {
        ...
        const gltf = imageDatas.map(_cargoToml.image_to_gltf);
        console.log(gltf);
    }
});

},{"./pix2gltfr/Cargo.toml":"3aFe9"}],"3aFe9":[function(require,module,exports) {
module.exports = {
    "package": {
        "name": "pix2gltfr",
        "version": "0.1.0",
...
},{}]},["fOQa2","ftAGR"], "ftAGR", "parcelRequirec286")
